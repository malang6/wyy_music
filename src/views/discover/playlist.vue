<template>
  <div class="musicList-out" @click="flag = false">
    <div class="content">
      <!-- 头部 -->
      <Up></Up>
...
export default {
  ...
  methods: {
    ...
    async reqFenleihandel() {
      ...
      // let languages = result.sub.filter((item) => item.category === 0);
      // let styles = result.sub.filter((item) => item.category === 1);
      // let scenes = result.sub.filter((item) => item.category === 2);
      // let mengmeng = result.sub.filter((item) => item.category === 3);
      // let theme = result.sub.filter((item) => item.category === 4);
      // let languages = [];
      // let styles = [];
      // let scenes = [];
      // let mengmeng = [];
